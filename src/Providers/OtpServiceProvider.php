...
namespace Thungdemo\LaravelOtp\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Validator;
use Illuminate\Mail\Mailer;
use Thungdemo\LaravelOtp\CodeGenerator;
use Thungdemo\LaravelOtp\Otp;
use Thungdemo\LaravelOtp\Console\MailMakeCommand;
